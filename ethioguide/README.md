...
│   │   │   │   └── bloc/       # View models or state management
...
│       ├── common_interface/   # Holds common interface for models for all features
│       ├── config/             # Configuration files (e.g., environment, app settings)
│       └── utils/              # General utilities (helpers, extensions, constants)
├── tests/                      # Unit and integration tests
│   ├── features/               # Tests for feature-specific code
│   └── core/                   # Tests for core utilities
├── docs/                       # Documentation files (kept at project root)
