...
// import { fetchUserProfile, updateUserProfile, updatePassword } from '@/app/store/slices/userSlice';
...
//       dispatch(updatePassword({ passwordData, token })).then((result) => {
//         if (result.meta.requestStatus === "fulfilled") {
...
//                 </div>
//                 <div className="flex gap-3">
//                   <Button className="text-white" onClick={handleSaveChanges} disabled={loading}>
...
//                 <PasswordInputBox label="New Password" value={newPassword} setPass={setNewPassword} placeHolder="Enter your new password" />
//                 <PasswordInputBox label="Confirm New Password" value={confirmPassword} setPass={setConfirmPassword} placeHolder="Enter your new password" />
//                 <Button className="bg-primary text-white" onClick={handleUpdatePassword} disabled={loading}>
