...
const departmentColors: Record<string, string> = {
  "HR Department": "bg-green-100 text-green-800",
  "IT Operations": "bg-yellow-100 text-yellow-800",
            ...
            <Card key={notice.id} className={`bg-white p-6 animate-in fade-in slide-in-from-bottom-4`} style={{ animationDelay: `${index * 100}ms` }}>
              <CardContent className="p-0">
                ...
                <div className="flex flex-wrap items-center gap-4 text-sm text-gray-500 mb-2">
                  ...
                  <Badge
                    className={`rounded-full px-3 py-1 text-xs font-medium ${departmentColors[notice.department] || "bg-gray-100 text-gray-800"}`}
                  >
                    {notice.department}
                  </Badge>
                  <span>
